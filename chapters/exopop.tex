...
\chapter{Exoplanet population inference and the abundance
         of Earth analogs from noisy, incomplete catalogs\chaplabel{exopop}}
...
\citet{Petigura:2013} recently published an exoplanet population analysis
...
To find this result, multiply the integrand in \eq{crazylike} by the trivial
\begin{eqnarray}
1 &=&
\frac{p(\{\entry_k\}\,|\,\{\data_k\},\,\interim)}
     {p(\{\entry_k\}\,|\,\{\data_k\},\,\interim)}
\end{eqnarray}
and use \eq{crazypost} to factorize the denominator and find
