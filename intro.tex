...
photometry measured by the \kepler\ Mission \dfmtodo{cite}.
The Mission enabled the discovery of over 5000 \dfmtodo{check} planets and planet
candidates outside the Solar System.
The zoo of planetary systems is extremely diverse and the statistics are now
sufficient to test theories of planet formation and evolution \dfmtodo{cite}.
